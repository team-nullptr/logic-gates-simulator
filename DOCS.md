...
Po wejściu w tryb edycji bramki nawigacja zmienia swój kolor na jasnofioletowy. Obok nazwy projektu pojawia się nazwa edytowanej bramki, którą możemy edytować w analogiczny sposób jak nazwę projektu (poprzez kliknięcie lewym przyciskiem myszy).

W tym momencie możemy ulepszać strukturę naszej stworzonej bramki (dodawać nowe wejścia, wyjścia i bramki wewnętrzne). Istotnie jest to, że nie możemy użyć bramki, która jest zależna od aktualnie edytowanej bramki. 
